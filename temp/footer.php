                ...
                <div class="row gutter-y-50">
                        ...
                        <div class="footer-widget footer-widget--about">
                            <div class="col-12 wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="00ms">
                                <a href="index.php" class="main-footer__logo">
                                    <img src="assets/images/footer-logo-light.png" width="119" alt="Logo" />
                                </a>
                                <!-- /.main-footer__logo -->
                    ...
                    <div class="col-lg-5 col-md-4 col-sm-8 col-xl-3 wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="600ms">
                        <div class="footer-widget footer-widget--gallery">
                            ...
                            <!-- /.footer-widget__title -->
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3437.0234306319016!2d77.02298789999999!3d11.010772800000002!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba8597eea719477%3A0xdce102170995650e!2sSree%20varsha%20engineering%20works!5e1!3m2!1sen!2sin!4v1746775602367!5m2!1sen!2sin" style="border: 0; width: -webkit-fill-available; height: -webkit-fill-available;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    ...
                    <!-- /.col-lg-5 col-md-4 col-sm-8 col-xl-3 -->
                </div>
                <!-- /.row -->
            </div>
            <!-- /.main-footer__widget -->
...
<div class="mobile-nav__wrapper">
    ...
    <div class="mobile-nav__content">
        ...
        <div class="logo-box">
            <a href="index.php" aria-label="logo image"><img src="assets/images/logo-light.png" width="100" alt="logo" /></a>
        </div>
        <!-- /.logo-box -->
...
<aside class="sidebar-one">
    ...
    <div class="sidebar-one__content">
        ...
        <div class="sidebar-one__about sidebar-one__item">
            <p class="sidebar-one__about__text">Providing fresh and organic meat from our farm in a very hygienic way.</p>
        </div>
        <!-- /.sidebar-one__about -->
        <div class="sidebar-one__info sidebar-one__item">
            ...
            <ul class="sidebar-one__info__list">
                <li>
                    ...
                    <address>No: 7, Sivaram Nagar, VR puram Hospital, Near, ESI medical college, Uppilipalayam, Coimbatore, Tamil Nadu - 641015</address>
                </li>
